...
"""EJERCICIO 1: Utilizando todo lo que sabes sobre cadenas, listas y
sus métodos internos, transforma este texto:
...
# texto = 'gordon lanzó su curva&strawberry ha fallado por un pie! -gritó Joe Castiglione&dos pies -le corrigió Troop&strawberry menea la cabeza como disgustado… -agrega el comentarista'
# lista = texto.split('&')
# lista[0] = lista[0] + '..' #una mejor opción sería -- lista[0] += '..'
# lista_mayusculas = []

# for elemento in lista:
#     elemento_mayuscula = elemento.capitalize()
#     lista_mayusculas.append(elemento_mayuscula)
    
# texto2 = '.\n- '.join(lista_mayusculas)
# texto2 += "."
# print(texto2)
...
"""
# dicc = {'dolar':'$','euro':'€', 'libra':'£'}
# divisa = input("ingrese la divisa: ").lower()

# print(dicc.get(divisa, "la divisa seleccionada no se encuentra disponible"))
...
# print(f"la suma de todos los numeros es {suma} y la suma de los elementos de la lista es {sum(sin_impares[1:])}")

'''Escribir un programa que pida al usuario un numero entero y muestre por pantalla un triangulo rectangulo como el de más abajo, de altura el número introducido
*
**
***
****
...
# numero_pisos = int(input("ingrese el numero de pisos: "))

# piso = 1

# for dato in range(1,numero_pisos+1):
#     print(dato * "*")

# for dato in range(numero_pisos):
#     print((dato+1) * "*")
    

# while piso <= numero_pisos:
#     print(piso * "*")
#     piso += 1
