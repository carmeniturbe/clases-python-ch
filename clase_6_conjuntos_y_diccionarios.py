...
''' EJERCICIOS HECHO POR CARMEN: '''

#EJERCICIO1: Crear un conjunto en Python que posea los siguientes elementos: 
...
"""RESPUESTA A EJERCICIO 2 CHAT GPT """
# # 1. Inicialmente el diccionario es: animales = {"elefante": ""}
# animales = {"elefante": ""}
...
# print(f'el numero total de creditos es {creditos["Matemáticas"] + creditos["Física"] + creditos["Química"]}')
