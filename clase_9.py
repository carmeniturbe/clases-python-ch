...
# print(par_o_impar(input("Ingresa un numero y te digo que es: ")))
# ====================================================================
# ====================================================================
...
"""ejercicio 3 Carmen
Escribir una funcion a la que se le pase una cadena del nombre de una ciudad y muestre por pantalla el saludo "hola bienbenidx a """

# def welcome(ciudad):
#     return "Hola Bienvenido a " + ciudad

# print(welcome("caracas"))
...
# mi_lista = [1, 2, 3, 4, 5]
# media = calcular_media(mi_lista)
# print("La media de la lista es:", media)

"""ejercicio 4 Carmen 
Crea una funcion que le pida dos numeros enteros al usuario y diga por consola, si alguno de ellos es 
múltiplo del otro"""
