...
# EJERCICIO MARVEL VS CAPCOM HECHO POR CARMEN:
# A>> fans marvel and nombre< m or fans capcom and nombre> 
# B >> el resto
# print('por favor escribir todo en minuscula')
# nombre = input('ingrese su nombre: ')
# preferencia = input('ingresa tu preferencia (capcom o marvel): ')

# print(nombre, preferencia)
