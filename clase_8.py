...
"""EJERCICIO 1: Crear un input que le pida la usuario sus hobbies favoritos y agregarlos en un archivo llamado miHobbieFavorito.txt  """
# archivo = open('miHobbieFavorito.txt', 'w')
# for numero in range(1, 4):
#     archivo.write(input(f'Ingrese su hobbie numero {numero}: ') + '\n')
# archivo.close()

"""EJERCICIO 1: HECHO POR CARMEN """

archivo = open('miHobbieFavorito.txt', 'w')
for numero in range(1,4):
    archivo.write(input(f"Escribe tu hobbie numero {numero}: ")+ "\n")
archivo.close()
